...
&& ./jdk/bin/jlink --compress=2 --no-header-files --strip-java-debug-attributes --no-man-pages --vm=server --module-path ./jdk/jmods --add-modules ALL-MODULE-PATH --output=./jre \
&& rm -rf ./jdk/ \
